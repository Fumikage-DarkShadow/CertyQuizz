...
export const EFREI_GOUVERNANCE_QUESTIONS: Question[] = [
  ...
  // =========================================================
  // G5 : Continuité et reprise (PCA / PRA) (10 QCM)
  // =========================================================

  { id: 'efr-g5-01', certId: 'efrei-gouvernance', domainId: 'g5', type: 'single', difficulty: 'hard',
    prompt: 'Quelle est la différence FONDAMENTALE entre PCA et PRA ?',
    options: [
      ...
      { id: 'c', text: 'Le PCA est gratuit, le PRA est payant', rationale: 'Aucune base.' },
      { id: 'd', text: 'Aucune différence, ce sont des synonymes', rationale: 'Faux : PCA et PRA sont distincts.' },
    ],
    correct: ['a'],
    explanation: 'PCA = **pendant le sinistre** ; PRA = **après le sinistre**.',
    references: [ANSSI_REF],
    tags: ['PCA vs PRA'] },

  { id: 'efr-g5-02', certId: 'efrei-gouvernance', domainId: 'g5', type: 'multi', difficulty: 'medium',
    prompt: 'Quels deux types de tests d\'un PCA sont reconnus par les bonnes pratiques ?',
    options: [
      { id: 'a', text: 'Test de personnalité des employés', rationale: 'Hors champ.' },
      { id: 'b', text: 'Test sur table (tabletop exercise) : revue collective du plan sans bascule réelle', rationale: 'Test classique : pédagogique, peu coûteux, valide la compréhension.' },
      { id: 'c', text: 'Test de bascule réelle vers le site de secours', rationale: 'Test ultime : valide l\'opérabilité technique de la reprise.' },
  ...
  { id: 'efr-g5-03', certId: 'efrei-gouvernance', domainId: 'g5', type: 'single', difficulty: 'hard',
    prompt: 'Une entreprise tolère 2 heures d\'indisponibilité maximum après un sinistre et accepte de perdre au plus 15 minutes de transactions. Le RTO et le RPO valent respectivement :',
    options: [
      { id: 'a', text: 'RTO = 2 h, RPO = 15 min', rationale: 'RTO = durée d\'indisponibilité acceptable, RPO = perte de données acceptable.' },
      { id: 'b', text: 'RTO = 15 min, RPO = 2 h', rationale: 'Inversé.' },
      { id: 'c', text: 'RTO = RPO = 2 h', rationale: 'Faux : ce sont deux indicateurs distincts.' },
      { id: 'd', text: 'RTO = 0 h, RPO = 0 min', rationale: 'Aspiration idéale mais ne correspond pas à l\'énoncé.' },
    ],
    correct: ['a'],
    explanation: '**RTO = temps**, **RPO = données** (mesurées en temps).',
    references: [ANSSI_REF],
    tags: ['RTO RPO'] },

  { id: 'efr-g5-04', certId: 'efrei-gouvernance', domainId: 'g5', type: 'single', difficulty: 'medium',
    prompt: 'Selon DORA, les politiques de continuité (PCA, PRA, sauvegardes) sont encadrées par :',
    options: [
      { id: 'a', text: 'Les articles 11 et 12 de DORA', rationale: 'Art. 11-12 : politiques et procédures de continuité TIC.' },
      { id: 'b', text: 'L\'article 19 de DORA', rationale: 'Art. 19 = notification des incidents majeurs, pas la continuité.' },
      { id: 'c', text: 'L\'article 28 de DORA', rationale: 'Art. 28 = registre des prestataires TIC.' },
      { id: 'd', text: 'Le RGPD article 32', rationale: 'Hors DORA.' },
    ],
    correct: ['a'],
    explanation: 'Continuité TIC = **DORA art. 11-12**.',
    references: [DORA_REF],
    tags: ['DORA art. 11-12', 'continuité'] },

  { id: 'efr-g5-05', certId: 'efrei-gouvernance', domainId: 'g5', type: 'single', difficulty: 'medium',
    prompt: 'Un site de secours qui réplique en quasi temps réel les données et reste prêt à prendre la main en quelques minutes est appelé :',
    options: [
      { id: 'a', text: 'Site froid (cold site)', rationale: 'Site froid = bâtiment vide, RTO de plusieurs jours.' },
      { id: 'b', text: 'Site tiède (warm site)', rationale: 'Site tiède = équipement présent mais données partielles, RTO de plusieurs heures.' },
      { id: 'c', text: 'Site chaud (hot site)', rationale: 'Site chaud = production miroir, RTO < 1 h, RPO faible.' },
      { id: 'd', text: 'Site fantôme', rationale: 'Terme non standard.' },
    ],
    correct: ['c'],
    explanation: '**Hot site** = quasi temps réel, faible RTO/RPO.',
    references: [ANSSI_REF],
    tags: ['hot site warm site cold site'] },

  { id: 'efr-g5-06', certId: 'efrei-gouvernance', domainId: 'g5', type: 'single', difficulty: 'easy',
    prompt: 'À quelle fréquence un PCA doit-il être au minimum testé selon les bonnes pratiques ANSSI ?',
    options: [
      { id: 'a', text: 'Tous les 5 ans', rationale: 'Trop espacé : la techno et l\'organisation changent plus vite.' },
      { id: 'b', text: 'Une fois lors de la rédaction puis jamais', rationale: 'Inacceptable : un PCA non testé n\'a aucune valeur.' },
      { id: 'c', text: 'Au moins une fois par an, avec mise à jour après chaque test ou changement majeur', rationale: 'Bonne pratique ANSSI : test annuel minimum + retours d\'expérience.' },
      { id: 'd', text: 'Tous les 10 ans', rationale: 'Bien trop tardif.' },
    ],
    correct: ['c'],
    explanation: 'PCA = test **annuel** minimum + révision après changements.',
    references: [ANSSI_REF],
    tags: ['fréquence test PCA'] },

  { id: 'efr-g5-07', certId: 'efrei-gouvernance', domainId: 'g5', type: 'single', difficulty: 'medium',
    prompt: 'Lors d\'une analyse BIA (Business Impact Analysis), l\'objectif principal est de :',
    options: [
      { id: 'a', text: 'Identifier les processus métiers critiques et leurs RTO/RPO afin de prioriser les efforts de continuité', rationale: 'Définition même du BIA : sortie utilisée pour calibrer le PCA.' },
      { id: 'b', text: 'Calculer le coût annuel de l\'antivirus', rationale: 'Hors BIA.' },
      { id: 'c', text: 'Choisir l\'hébergeur cloud', rationale: 'Hors BIA.' },
      { id: 'd', text: 'Recruter le RSSI', rationale: 'Hors sujet.' },
    ],
    correct: ['a'],
    explanation: 'BIA = **prioriser** les processus critiques pour calibrer le PCA.',
    references: [{ label: 'ANSSI guide PCA', url: 'https://cyber.gouv.fr/' }],
    tags: ['BIA'] },

  { id: 'efr-g5-08', certId: 'efrei-gouvernance', domainId: 'g5', type: 'single', difficulty: 'hard',
    prompt: 'Quelle stratégie de sauvegarde est recommandée par l\'ANSSI face aux rançongiciels modernes ?',
    options: [
      { id: 'a', text: 'Une copie unique sur le serveur de production', rationale: 'Inacceptable : rançongiciel chiffre la copie en même temps.' },
      { id: 'b', text: 'La règle 3-2-1-1-0 : 3 copies, 2 supports, 1 hors site, 1 immutable, 0 erreur', rationale: 'Évolution moderne de 3-2-1 introduisant l\'immutabilité (anti rançongiciel).' },
      { id: 'c', text: 'Une sauvegarde sur clé USB locale', rationale: 'Insuffisant et risqué.' },
      { id: 'd', text: 'Pas de sauvegarde, on restaure depuis git', rationale: 'Aberrant pour des données métiers.' },
    ],
    correct: ['b'],
    explanation: 'Rançongiciel = **3-2-1-1-0** avec **copie immutable**.',
    references: [{ label: 'ANSSI rançongiciels', url: 'https://cyber.gouv.fr/' }],
    tags: ['sauvegarde 3-2-1-1-0', 'ransomware'] },

  { id: 'efr-g5-09', certId: 'efrei-gouvernance', domainId: 'g5', type: 'single', difficulty: 'medium',
    prompt: 'Le rôle de la cellule de crise pendant l\'activation d\'un PCA est principalement de :',
    options: [
      { id: 'a', text: 'Réécrire la documentation technique du SI', rationale: 'Hors mission de la cellule de crise.' },
      { id: 'b', text: 'Coordonner les actions, prendre les décisions stratégiques et communiquer aux parties prenantes', rationale: 'Mission classique : décider, coordonner, communiquer.' },
      { id: 'c', text: 'Auditer la conformité ISO 27001', rationale: 'C\'est le rôle d\'un auditeur, pas de la cellule de crise.' },
      { id: 'd', text: 'Renégocier les SLA', rationale: 'Hors urgence opérationnelle.' },
    ],
    correct: ['b'],
    explanation: 'Cellule de crise = **décider + coordonner + communiquer**.',
    references: [ANSSI_REF],
    tags: ['cellule de crise'] },

  { id: 'efr-g5-10', certId: 'efrei-gouvernance', domainId: 'g5', type: 'multi', difficulty: 'hard',
    prompt: 'Quelles affirmations sont VRAIES sur la relation entre RTO, RPO et stratégie de sauvegarde ?',
    options: [
      { id: 'a', text: 'Plus le RPO cible est court, plus la fréquence des sauvegardes doit être élevée', rationale: 'RPO 15 min impose des sauvegardes ou de la réplication toutes les 15 min au plus.' },
      { id: 'b', text: 'Plus le RTO cible est court, plus l\'infrastructure de reprise doit être proche du temps réel (hot site)', rationale: 'RTO < 1 h impose une infra prête à prendre la main quasi immédiatement.' },
      { id: 'c', text: 'RTO et RPO peuvent toujours être nuls sans coût supplémentaire', rationale: 'Faux : RTO/RPO proches de 0 coûtent très cher (réplication synchrone, hot site).' },
      { id: 'd', text: 'RPO concerne la durée et RTO concerne la quantité de données', rationale: 'Inversé.' },
    ],
    correct: ['a', 'b'],
    explanation: 'RTO/RPO **plus serrés = plus coûteux**, pilotent la stratégie de sauvegarde et de site.',
    references: [ANSSI_REF],
    tags: ['RTO RPO stratégie'] },

  // =========================================================
  // Compléments de cours (méthodologie, principes) (15 QCM)
  // =========================================================

  { id: 'efr-g1-21', certId: 'efrei-gouvernance', domainId: 'g1', type: 'single', difficulty: 'medium',
    prompt: 'Le cycle PDCA (Plan, Do, Check, Act) appliqué à un SMSI ISO 27001 sert à :',
    options: [
      { id: 'a', text: 'Calculer le ROI d\'un projet IT', rationale: 'Hors PDCA.' },
      { id: 'b', text: 'Inscrire la sécurité dans une démarche d\'amélioration continue (planification, mise en œuvre, vérification, ajustement)', rationale: 'Définition même du cycle PDCA appliqué au SMSI.' },
      { id: 'c', text: 'Remplacer un audit externe', rationale: 'Le PDCA et l\'audit sont complémentaires, pas substituables.' },
      { id: 'd', text: 'Documenter un incident', rationale: 'Hors PDCA.' },
    ],
    correct: ['b'],
    explanation: 'PDCA = **amélioration continue** du SMSI.',
    references: [{ label: 'ISO 27001 PDCA', url: 'https://www.iso.org/standard/27001' }],
    tags: ['PDCA', 'amélioration continue'] },

  { id: 'efr-g1-22', certId: 'efrei-gouvernance', domainId: 'g1', type: 'single', difficulty: 'hard',
    prompt: 'Quelle norme spécifie la GESTION DES RISQUES de sécurité et est utilisée en complément d\'EBIOS RM ?',
    options: [
      { id: 'a', text: 'ISO 19011', rationale: 'C\'est la norme audit, pas la gestion des risques.' },
      { id: 'b', text: 'ISO 27001', rationale: 'Cadre le SMSI, pas la méthode risques en détail.' },
      { id: 'c', text: 'ISO/IEC 27005', rationale: 'Norme dédiée à la gestion des risques sécurité, alignée sur ISO 31000.' },
      { id: 'd', text: 'COBIT 2019', rationale: 'Référentiel de gouvernance global, pas méthode risques.' },
    ],
    correct: ['c'],
    explanation: '**ISO/IEC 27005** = gestion des risques sécurité.',
    references: [{ label: 'ISO 27005', url: 'https://www.iso.org/standard/80585.html' }],
    tags: ['ISO 27005'] },

  { id: 'efr-g2-21', certId: 'efrei-gouvernance', domainId: 'g2', type: 'single', difficulty: 'medium',
    prompt: 'Dans le cours, le critère DICT ajoute la T à la triade CIA classique. Que désigne cette T ?',
    options: [
      { id: 'a', text: 'Tolérance aux pannes', rationale: 'Concept distinct, pas DICT.' },
      { id: 'b', text: 'Traçabilité', rationale: 'Le T de DICT correspond à la **traçabilité** des actions sur les valeurs métier.' },
      { id: 'c', text: 'Transparence', rationale: 'Pas un critère sécurité officiel ANSSI.' },
      { id: 'd', text: 'Téléchargement', rationale: 'Aberrant.' },
    ],
    correct: ['b'],
    explanation: 'DICT = Disponibilité, Intégrité, Confidentialité, **Traçabilité**.',
    references: [EBIOS_REF],
    tags: ['DICT'] },

  { id: 'efr-g3-15', certId: 'efrei-gouvernance', domainId: 'g3', type: 'multi', difficulty: 'hard',
    prompt: 'Quelles sont les 4 stratégies de TRAITEMENT du risque issues de l\'atelier 5 EBIOS RM ?',
    options: [
      { id: 'a', text: 'Réduire (mesures de sécurité) et Partager (assurance, sous-traitance contractualisée)', rationale: 'Deux des quatre stratégies officielles.' },
      { id: 'b', text: 'Refuser (suppression de l\'activité ou du périmètre) et Accepter (risque résiduel sous seuil)', rationale: 'Les deux autres stratégies officielles.' },
      { id: 'c', text: 'Ignorer le risque', rationale: 'Aucune stratégie officielle ne consiste à ignorer un risque.' },
      { id: 'd', text: 'Cacher le risque à la direction', rationale: 'Pratique inacceptable, contraire à la gouvernance.' },
    ],
    correct: ['a', 'b'],
    explanation: '4 stratégies : **Réduire, Partager, Refuser, Accepter**.',
    references: [EBIOS_REF],
    tags: ['traitement risque', 'EBIOS atelier 5'] },

  { id: 'efr-g4-17', certId: 'efrei-gouvernance', domainId: 'g4', type: 'single', difficulty: 'medium',
    prompt: 'Le principe d\'accountability du RGPD (article 5-2) impose au responsable de traitement de :',
    options: [
      { id: 'a', text: 'Pouvoir démontrer à tout moment sa conformité (registre, politiques, journaux)', rationale: 'Définition de l\'accountability : non seulement être conforme mais pouvoir le prouver.' },
      { id: 'b', text: 'Verser une caution à la CNIL', rationale: 'Aberrant.' },
      { id: 'c', text: 'Auditer ses concurrents', rationale: 'Hors champ.' },
      { id: 'd', text: 'Publier toutes ses données', rationale: 'L\'inverse de la confidentialité.' },
    ],
    correct: ['a'],
    explanation: 'Accountability art. 5-2 = **prouver** sa conformité.',
    references: [RGPD_REF],
    tags: ['RGPD accountability'] },

  { id: 'efr-g6-16', certId: 'efrei-gouvernance', domainId: 'g6', type: 'single', difficulty: 'hard',
    prompt: 'L\'article 32 du RGPD (sécurité du traitement) impose au minimum :',
    options: [
      { id: 'a', text: 'Une certification ISO 27001 obligatoire', rationale: 'Faux : l\'art. 32 cite la certification comme moyen possible mais non obligatoire.' },
      { id: 'b', text: 'Des MTO appropriées : pseudonymisation, chiffrement, garantie de confidentialité, intégrité, disponibilité, résilience, et tests réguliers', rationale: 'Énumération exacte de l\'article 32 RGPD.' },
      { id: 'c', text: 'Le recrutement obligatoire d\'un DPO', rationale: 'L\'obligation DPO découle de l\'art. 37, pas de l\'art. 32.' },
      { id: 'd', text: 'L\'achat d\'un SIEM', rationale: 'Hors champ texte.' },
    ],
    correct: ['b'],
    explanation: 'RGPD art. 32 = **MTO appropriées + tests réguliers**.',
    references: [RGPD_REF],
    tags: ['RGPD art. 32', 'MTO'] },

  { id: 'efr-g6-17', certId: 'efrei-gouvernance', domainId: 'g6', type: 'multi', difficulty: 'hard',
    prompt: 'Les 6 bases légales de l\'article 6 RGPD permettant un traitement de DCP incluent :',
    options: [
      { id: 'a', text: 'Le consentement de la personne et l\'exécution d\'un contrat', rationale: 'Deux des six bases listées à l\'art. 6.' },
      { id: 'b', text: 'L\'obligation légale et l\'intérêt légitime du responsable', rationale: 'Deux autres bases listées.' },
      { id: 'c', text: 'La curiosité de l\'employeur', rationale: 'Aucune base juridique.' },
      { id: 'd', text: 'Le hasard', rationale: 'Aucune base juridique.' },
    ],
    correct: ['a', 'b'],
    explanation: '6 bases art. 6 : consentement, contrat, obligation légale, intérêt vital, mission d\'intérêt public, intérêt légitime.',
    references: [RGPD_REF],
    tags: ['RGPD art. 6', 'bases légales'] },

  { id: 'efr-g6-18', certId: 'efrei-gouvernance', domainId: 'g6', type: 'single', difficulty: 'medium',
    prompt: 'Une violation de DCP présentant un risque ÉLEVÉ pour les personnes concernées doit faire l\'objet :',
    options: [
      { id: 'a', text: 'D\'une simple inscription au registre interne', rationale: 'Insuffisant si risque élevé.' },
      { id: 'b', text: 'D\'une notification à la CNIL dans les 72 h ET d\'une communication aux personnes concernées sans délai injustifié (art. 33 + art. 34)', rationale: 'Cumul d\'obligations imposé par le RGPD en cas de risque élevé.' },
      { id: 'c', text: 'D\'un rapport au COMEX uniquement', rationale: 'Insuffisant : la CNIL et les personnes doivent être informées.' },
      { id: 'd', text: 'Aucune obligation tant que les données ne sont pas publiées', rationale: 'Faux : obligation indépendante de la publication.' },
    ],
    correct: ['b'],
    explanation: 'Risque élevé = **CNIL 72 h (art. 33)** + **personnes concernées sans délai (art. 34)**.',
    references: [RGPD_REF],
    tags: ['RGPD art. 33-34'] },

  { id: 'efr-g6-19', certId: 'efrei-gouvernance', domainId: 'g6', type: 'single', difficulty: 'medium',
    prompt: 'Les droits des personnes concernées par un traitement RGPD couvrent notamment :',
    options: [
      { id: 'a', text: 'Accès, rectification, effacement, limitation, portabilité, opposition (art. 15 à 22)', rationale: 'Six droits principaux listés au chapitre III RGPD.' },
      { id: 'b', text: 'Le droit de modifier les conditions générales du responsable', rationale: 'Aucun fondement.' },
      { id: 'c', text: 'Le droit de fixer le tarif des services', rationale: 'Hors RGPD.' },
      { id: 'd', text: 'Le droit d\'auditer les locaux', rationale: 'Hors RGPD pour la personne concernée.' },
    ],
    correct: ['a'],
    explanation: 'Droits art. 15 à 22 : **accès, rectification, effacement, limitation, portabilité, opposition**.',
    references: [RGPD_REF],
    tags: ['RGPD droits'] },

  { id: 'efr-g6-20', certId: 'efrei-gouvernance', domainId: 'g6', type: 'single', difficulty: 'hard',
    prompt: 'Le cadre de gouvernance des risques TIC imposé par DORA article 5 fait peser la responsabilité :',
    options: [
      { id: 'a', text: 'Sur le RSSI uniquement', rationale: 'Insuffisant : DORA remonte la responsabilité au plus haut.' },
      { id: 'b', text: 'Sur l\'organe de direction (conseil, comité exécutif), qui doit définir, approuver et superviser le cadre', rationale: 'Article 5 : la direction porte la responsabilité ultime.' },
      { id: 'c', text: 'Sur le service achats', rationale: 'Pas le pilote DORA art. 5.' },
      { id: 'd', text: 'Sur la CNIL', rationale: 'CNIL = RGPD, pas DORA.' },
    ],
    correct: ['b'],
    explanation: 'DORA art. 5 = **organe de direction** responsable du cadre TIC.',
    references: [DORA_REF],
    tags: ['DORA art. 5', 'gouvernance'] },

  { id: 'efr-g6-21', certId: 'efrei-gouvernance', domainId: 'g6', type: 'single', difficulty: 'medium',
    prompt: 'Sous NIS2, la distinction entre entités essentielles et entités importantes affecte principalement :',
    options: [
      { id: 'a', text: 'Le régime de supervision (a priori vs a posteriori) et les plafonds de sanctions', rationale: 'Essentielles : supervision proactive et sanctions plus lourdes ; importantes : supervision réactive.' },
      { id: 'b', text: 'La couleur du logo de l\'entreprise', rationale: 'Aberrant.' },
      { id: 'c', text: 'Le nombre de salariés à embaucher', rationale: 'Hors NIS2.' },
      { id: 'd', text: 'Aucune différence pratique', rationale: 'Faux : la distinction a des effets juridiques concrets.' },
    ],
    correct: ['a'],
    explanation: 'NIS2 : **supervision et sanctions** plus strictes pour les essentielles.',
    references: [NIS2_REF],
    tags: ['NIS2 essentielles vs importantes'] },

  { id: 'efr-g6-22', certId: 'efrei-gouvernance', domainId: 'g6', type: 'single', difficulty: 'hard',
    prompt: 'L\'article 28 de DORA impose aux entités financières de tenir :',
    options: [
      { id: 'a', text: 'Un registre des prestataires TIC, identifiant ceux qui supportent des fonctions critiques ou importantes', rationale: 'Article 28 DORA : registre obligatoire des prestataires TIC.' },
      { id: 'b', text: 'Un registre des activités de traitement (RGPD art. 30)', rationale: 'Confusion avec le RGPD.' },
      { id: 'c', text: 'Un registre des incidents NIS2', rationale: 'NIS2 a son propre régime, mais pas via DORA art. 28.' },
      { id: 'd', text: 'Aucun registre n\'est exigé', rationale: 'Faux : le registre est explicitement exigé.' },
    ],
    correct: ['a'],
    explanation: 'DORA art. 28 = **registre des prestataires TIC**.',
    references: [DORA_REF],
    tags: ['DORA art. 28', 'registre prestataires'] },

  { id: 'efr-g6-23', certId: 'efrei-gouvernance', domainId: 'g6', type: 'single', difficulty: 'medium',
    prompt: 'La SCA (Strong Customer Authentication) imposée par DSP2 dans les services de paiement nécessite au moins :',
    options: [
      { id: 'a', text: 'Un seul facteur d\'authentification (mot de passe)', rationale: 'Insuffisant pour SCA.' },
      { id: 'b', text: 'Deux facteurs parmi connaissance, possession, inhérence, indépendants', rationale: 'Définition même de la SCA en application de DSP2.' },
      { id: 'c', text: 'Trois facteurs minimum', rationale: 'Faux : la SCA exige deux facteurs minimum.' },
      { id: 'd', text: 'Un appel téléphonique', rationale: 'Pas un facteur d\'authentification réglementaire.' },
    ],
    correct: ['b'],
    explanation: 'SCA = **2 facteurs indépendants** parmi savoir / posséder / être.',
    references: [{ label: 'EBA SCA RTS', url: 'https://www.eba.europa.eu/' }],
    tags: ['SCA', 'DSP2'] },

  { id: 'efr-g4-18', certId: 'efrei-gouvernance', domainId: 'g4', type: 'multi', difficulty: 'hard',
    prompt: 'Quels éléments doivent obligatoirement figurer dans un DPA (RGPD art. 28) ?',
    options: [
      { id: 'a', text: 'Objet, durée, nature et finalité du traitement, types de données et catégories de personnes', rationale: 'Liste de l\'art. 28 RGPD.' },
      { id: 'b', text: 'Obligations et droits du responsable, mesures techniques et organisationnelles, sous-traitance ultérieure, droit d\'audit', rationale: 'Suite obligatoire des clauses art. 28.' },
      { id: 'c', text: 'Le menu de la cantine', rationale: 'Hors champ.' },
      { id: 'd', text: 'Le plan de licenciement', rationale: 'Hors champ.' },
    ],
    correct: ['a', 'b'],
    explanation: 'DPA art. 28 = **clauses obligatoires** : objet, durée, MTO, sous-traitance, audit.',
    references: [RGPD_REF],
    tags: ['RGPD art. 28', 'DPA'] },

  { id: 'efr-g2-22', certId: 'efrei-gouvernance', domainId: 'g2', type: 'single', difficulty: 'hard',
    prompt: 'EBIOS RM combine deux approches complémentaires. Lesquelles ?',
    options: [
      { id: 'a', text: 'Approche par scénarios uniquement', rationale: 'Incomplet : EBIOS RM combine deux approches.' },
      { id: 'b', text: 'Approche par conformité (socle de sécurité) et approche par scénarios', rationale: 'Définition explicite de la méthode ANSSI.' },
      { id: 'c', text: 'Approche par mots de passe et approche par chiffrement', rationale: 'Hors méthode.' },
      { id: 'd', text: 'Approche financière et approche juridique', rationale: 'Hors méthode.' },
    ],
    correct: ['b'],
    explanation: 'EBIOS RM = **conformité (socle)** + **scénarios**.',
    references: [EBIOS_REF],
    tags: ['EBIOS RM approches'] },
